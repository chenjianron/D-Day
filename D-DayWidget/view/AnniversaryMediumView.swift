...
@available(iOS 13.0, *)
struct AnniversaryMediumView: View {
    ...
    var body: some View {
            ZStack{
                Image(uiImage: #imageLiteral(resourceName: "Anniversary-SmallComponent-Medium"))
                    .resizable()
...
//                            .foregroundColor(.white)
//                            .lineLimit(1)
//                            .padding(EdgeInsets(top: G.share.h(15), leading: 0, bottom: 0, trailing: 0))
                    }
                }
                .padding(EdgeInsets(top: 48, leading: 24, bottom: 41, trailing: 24))
//                .frame(height:78)
//                .clipped()
            }
    }
